...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    },
    {
      ...
      name: '博客',
      method: 'HEAD',
      target: 'https://blog.zhaizz.top/',
      statusPageLink: 'https://blog.zhaizz.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '图床',
      method: 'HEAD',
      target: 'https://img.zhaizz.top/',
      statusPageLink: 'https://img.zhaizz.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
  ...
  notification: {
    ...
    webhook: {
      ...
      payload: {
        "from": "系统状态更新 <uptimeflare@zhaizz.top>",
        "to": ["zhaimou81@qq.com"],
